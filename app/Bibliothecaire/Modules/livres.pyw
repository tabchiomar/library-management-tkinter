...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Gestion des livres - Bibliothécaire")
    ...
    def select_frame_by_name(self, name):
        ...
        self.entry = customtkinter.CTkEntry(self, placeholder_text='Chercher par ID ou par nom de livre', width=650)
        ...
        def insert():
            ...
            if(title=='' or cat=='' or aut=='' or desc=='' or annee=='' or rayon==''):
                ...
                if(numrows==0):
                    ...
                    conn.commit()
                    print('done')
                    CTkMessagebox(title='Succès',message='Livre ajouté!', icon="warning")
                else:
        ...
        submit = customtkinter.CTkButton(self.add_frame, text= " Ajouter livre " , command=insert)
